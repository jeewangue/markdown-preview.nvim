...
GH_REPO="$GH_API/repos/jeewangue/markdown-preview.nvim"
...
do
  GH_ASSET="https://uploads.github.com/repos/jeewangue/markdown-preview.nvim/releases/$id/assets?name=$filename"
